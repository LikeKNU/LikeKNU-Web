        ...
        menuList.map((menu, index) => (
          <MenuCardContainer key={index}>
            <Title>
              ...
              {
                menu.operatingTime ? <OperatingTime>{menu.operatingTime}</OperatingTime> : <OperatingTime>운영하지 않음</OperatingTime>
              }
            </Title>
            <Content>
              {
                menu.menus.map((menu, index) => (
                  <div className={"menuItem"} key={index}>{menu.menuName}</div>
                ))
              }
            </Content>
          </MenuCardContainer>
